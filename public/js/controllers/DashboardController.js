angular.module('DashboardController', []).controller('DashboardController', function($scope, $state, $stateParams, $window, Domain, NgTableParams) {
	...
	this.charts = {
		...
		monthly: {
			data: [],
			labels: ['Aug 2018', 'Sept 2018', 'Oct 2018', 'Nov 2018', 'Dec 2018', 'Jan 2019', 'Feb 2019', 'Mar 2019', 'Apr 2019', 'May 2019', 'June 2019', 'July 2019'],
			options: {
				responsive: true,
	...
	this.computeStats = () => {
		...
		this.stats = stats
		this.charts.severities.data = [this.stats.severities.critical, this.stats.severities.high, this.stats.severities.medium, this.stats.severities.low, this.stats.severities.none]
		var months = ['2018-08','2018-09','2018-10','2018-11','2018-12','2019-01','2019-02','2019-03','2019-04','2019-05','2019-06','2019-07']
